...
function DownCause() {
    ...
    const handleSubmit = (e) => {
        ...
        if (!stopCause.length) {
            ...
            message.innerHTML = "Вы забыли добавить причину останова";
            setWorkerId("");
            setStopCause("");
            setStoppageTime("");
            setResumeTime("");
        ...
        if (resultResume < resultStoppage) {
            dateTimeMessage.innerHTML = "Время начало останова не может быть больше или равна время окончания работ";
            setWorkerId("");
            setStopCause("");
            setStoppageTime("");
            setResumeTime("");
        ...
        let params =
            {
                'worker': workerId,
                "unit": query.get("techId"),
                "stop_cause": stopCause,
                "time_of_stoppage": typeof (stoppageTime),
